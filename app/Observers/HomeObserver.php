...
class HomeObserver
{
    ...
    public function updated(Home $home): void
    {
        ...
        // attractions_images
        if ($home->isDirty('attractions_images')) {
            $original = $home->getOriginal('attractions_images');
            $current = $home->attractions_images;
            $deletedImages = array_diff($original, $current);
    ...
    public function deleted(Home $home): void
    {
        ...
        // attractions_images
        if (!is_null($home->attractions_images)) {
            Storage::disk('public')->delete($home->getOriginal('attractions_images'));
        }
    }
