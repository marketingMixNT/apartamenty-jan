...
use App\Filament\Resources\PageOtherObjectsResource\Pages;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;
use App\Filament\Resources\PageOtherObjectsResource\RelationManagers;

class PageOtherObjectsResource extends Resource
{
    use Translatable;
    ...
    protected static ?string $model = PageOtherObjects::class;
    ...
    public static function table(Table $table): Table
    {
        ...
        Tables\Columns\TextColumn::make('header_heading')
            ->label('Nagłowek')
            ->description(function (PageOtherObjects $record) {
    ...
    {
        return [
            'index' => Pages\ListPageOtherObjects::route('/'),
            'create' => Pages\CreatePageOtherObjects::route('/create'),
            'edit' => Pages\EditPageOtherObjects::route('/{record}/edit'),
        ];
    }
