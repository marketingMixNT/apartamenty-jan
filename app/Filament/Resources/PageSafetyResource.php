...
use App\Filament\Resources\PageSafetyResource\Pages;
use App\Filament\Resources\PageSafetyResource\RelationManagers;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;

class PageSafetyResource extends Resource
{
    use Translatable;
    ...
    protected static ?string $model = PageSafety::class;
    ...
    public static function table(Table $table): Table
    {
        ...
        Tables\Columns\TextColumn::make('header_heading')
            ->label('Nagłowek')
            ->description(function (PageSafety $record) {
    ...
    {
        return [
            'index' => Pages\ListPageSafeties::route('/'),
            'create' => Pages\CreatePageSafety::route('/create'),
            'edit' => Pages\EditPageSafety::route('/{record}/edit'),
        ];
    }
