<section class="py-16 bg-bgSecondary">
    <x-container class="max-w-screen-xl">
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-16 md:w-[75%] lg:w-full mx-auto">
            ...
            <x-feature-card title="{{__('home.features.title-5')}}"
                text="{{__('home.features.text-5')}}">
                <x-tabler-clock-24 class="size-12 text-accent-400" />
            </x-feature-card>

            <x-feature-card title="{{__('home.features.title-6')}}"
                text="{{__('home.features.text-6')}}">
                <x-lucide-car class="w-12 text-accent-400" />
            </x-feature-card>
